...
func (m *DiagnosisMutation) AddDiagnosiIDs(ids ...int) {
	if m.diagnosis == nil {
...
// ClearDiagnosis clears the "diagnosis" edge to the Doctor entity.
func (m *DiagnosisMutation) ClearDiagnosis() {
	m.cleareddiagnosis = true
}

// DiagnosisCleared returns if the "diagnosis" edge to the Doctor entity was cleared.
func (m *DiagnosisMutation) DiagnosisCleared() bool {
	return m.cleareddiagnosis
}

// RemoveDiagnosiIDs removes the "diagnosis" edge to the Doctor entity by IDs.
func (m *DiagnosisMutation) RemoveDiagnosiIDs(ids ...int) {
...
// RemovedDiagnosis returns the removed IDs of the "diagnosis" edge to the Doctor entity.
func (m *DiagnosisMutation) RemovedDiagnosisIDs() (ids []int) {
...
// DiagnosisIDs returns the "diagnosis" edge IDs in the mutation.
func (m *DiagnosisMutation) DiagnosisIDs() (ids []int) {
...
// ResetDiagnosis resets all changes to the "diagnosis" edge.
func (m *DiagnosisMutation) ResetDiagnosis() {
	m.diagnosis = nil
...
func (m *DiagnosisMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.diagnosis != nil {
		edges = append(edges, diagnosis.EdgeDiagnosis)
	}
	return edges
}
...
// SetProcedureType sets the "ProcedureType" field.
func (m *ProcedureTypeMutation) SetProcedureType(s string) {
	m._ProcedureType = &s
}

// ProcedureType returns the value of the "ProcedureType" field in the mutation.
func (m *ProcedureTypeMutation) ProcedureType() (r string, exists bool) {
	v := m._ProcedureType
	if v == nil {
		return
	}
...
// OldProcedureType returns the old "ProcedureType" field's value of the ProcedureType entity.
// If the ProcedureType object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProcedureTypeMutation) OldProcedureType(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldProcedureType is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldProcedureType requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
...
// ResetProcedureType resets all changes to the "ProcedureType" field.
func (m *ProcedureTypeMutation) ResetProcedureType() {
	m._ProcedureType = nil
}
...
func (m *ProcedureTypeMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m._ProcedureType != nil {
		fields = append(fields, proceduretype.FieldProcedureType)
	}
	return fields
}
...
func (m *ProcedureTypeMutation) Field(name string) (ent.Value, bool) {
	switch name {
	case proceduretype.FieldProcedureType:
