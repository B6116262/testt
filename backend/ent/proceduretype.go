...
type ProcedureType struct {
	...
	// ProcedureType holds the value of the "ProcedureType" field.
	...
	for i := range columns {
		...
		case proceduretype.FieldProcedureType:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field ProcedureType", values[i])
			} else if value.Valid {
				pt.ProcedureType = value.String
			}
		}
	}
	return nil
...
func (pt *ProcedureType) String() string {
	...
	builder.WriteString(", ProcedureType=")
	builder.WriteString(pt.ProcedureType)
	builder.WriteByte(')')
