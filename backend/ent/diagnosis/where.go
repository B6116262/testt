...
func HasDiagnosis() predicate.Diagnosis {
	return predicate.Diagnosis(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DiagnosisTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, DiagnosisTable, DiagnosisPrimaryKey...),
		)
...
func HasDiagnosisWith(preds ...predicate.Doctor) predicate.Diagnosis {
	return predicate.Diagnosis(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
