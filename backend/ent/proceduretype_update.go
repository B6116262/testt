...
func (ptu *ProcedureTypeUpdate) SetProcedureType(s string) *ProcedureTypeUpdate {
	ptu.mutation.SetProcedureType(s)
	return ptu
}
...
func (ptu *ProcedureTypeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ptu.mutation.ProcedureType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: proceduretype.FieldProcedureType,
		})
	}
...
// SetProcedureType sets the "ProcedureType" field.
func (ptuo *ProcedureTypeUpdateOne) SetProcedureType(s string) *ProcedureTypeUpdateOne {
	ptuo.mutation.SetProcedureType(s)
	return ptuo
}
...
func (ptuo *ProcedureTypeUpdateOne) sqlSave(ctx context.Context) (_node *ProcedureType, err error) {
	...
	if value, ok := ptuo.mutation.ProcedureType(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: proceduretype.FieldProcedureType,
