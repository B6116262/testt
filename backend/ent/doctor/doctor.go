...
const (
	...
	// DoctorToDiagnosisTable is the table the holds the DoctorToDiagnosis relation/edge. The primary key declared below.
	DoctorToDiagnosisTable = "doctor_DoctorToDiagnosis"
...
var (
	// DoctorToDiagnosisPrimaryKey and DoctorToDiagnosisColumn2 are the table columns denoting the
	// primary key for the DoctorToDiagnosis relation (M2M).
	DoctorToDiagnosisPrimaryKey = []string{"doctor_id", "diagnosis_id"}
)
